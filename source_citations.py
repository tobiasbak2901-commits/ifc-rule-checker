...
def _to_source_citation(raw: object, rule_id: str, yaml_path: Optional[str] = None) -> SourceCitation:
    ...
    clause = source.get("clause") or section
...
def citation_label(citation: SourceCitation) -> str:
    ...
    section_or_clause = citation.section or citation.clause
    if section_or_clause:
        parts.append(str(section_or_clause))
...
def citation_details(citation: SourceCitation) -> str:
    lines = [
        ...
        f"Section: {citation.section or citation.clause or '-'}",
    ...
    if citation.excerpt:
        ...
        lines.append(str(citation.excerpt))
    if citation.note:
        lines.append("")
